     ...
     switch(event.type)
    {
        ...
        case SDL_KEYDOWN:
                switch (event.key.keysym.sym)
                {
                    ...
                    {
                		update_1_(&pMprochaine.position_perso , &pM.position_perso,&p.position_perso,distance,longueur,longueurM);
                    }
                    ...
                    {
                        update_2_(&pMprochaine.position_perso , &pM.position_perso,&p.position_perso,distance,longueur,longueurM);
                    }
                    else{
                        pMprochaine.position_perso.x=pM.position_perso.x;
                    }     		
